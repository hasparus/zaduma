...
function y(t) {
  for (var n = [], e = 0, o = 0, s = 0; s < t.length; )
    (e = t.charCodeAt(s++)),
      o
        ? (n.push((65536 + ((o - 55296) << 10) + (e - 56320)).toString(16)),
          (o = 0))
        : 55296 <= e && e <= 56319
        ? (o = e)
...
var C = i.initWasm(N),
  ...
  R =
    ((u =
      (f = globalThis == null ? void 0 : globalThis.process) == null
        ? void 0
        : f.env) == null
      ? void 0
...
var g = new Map(),
  F = ({ emoji: t }) => {
    let n = async (e, o) => {
      if (e === "emoji")
        return (
          "data:image/svg+xml;base64," + btoa(await (await m(c(o), t)).text())
        );
      l[e] || (e = "unknown");
      try {
        let s = await k(l[e], o);
          ...
          async start(a) {
            ...
            let d = await _,
              h = await b(n, {
                ...
                debug: o.debug,
                fonts: o.fonts || [
                  { name: "sans serif", data: d, weight: 700, style: "normal" },
                ],
                loadAdditionalAsset: F({ emoji: o.emoji }),
              }),
              w = new i.Resvg(h, { fitTo: { mode: "width", value: o.width } });
